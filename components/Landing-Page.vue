	...
	<div class="landing-page wrapper">
		...
		<div class="social-cta">
			<ul class="social c2alinks">
				<li>
					<a href="https://www.instagram.com/think.senpai/" target="_blank">
						<svg
							fill="#525252"
							viewBox="0 0 48 48"
							version="1.1"
				...
				<li>
					<a href="https://medium.com/think-senpai" target="_blank">
              ...
              L19.6,510.4H3.5l-139-303.2v203.2c-1.2,8.5,1.7,17.1,7.7,23.3l55.8,67.7v8.9h-158.3v-8.9l55.8-67.7c6-6.2,8.6-14.8,7.2-23.3V175.5z"
				...
				<li>
					<a href="https://www.linkedin.com/company/senpai/" target="_blank">
						<svg
							fill="#525252"
							viewBox="0 0 44 40"
							version="1.1"
						...
						>
							...
							<defs></defs>
							<g id="Icons" stroke-width="1">
								<g id="Black" transform="translate(-702.000000, -265.000000)">
									<path
										id="LinkedIn"
				...
				<li>
					<a href="https://twitter.com/think_senpai" target="_blank">
						<svg
							viewBox="0 0 26 21"
							fill="#525252"
							xmlns="http://www.w3.org/2000/svg"
			...
			<div class="main-post">
				<nuxt-link
					:to="{
						name: 'category-slug',
						params: {
							category: featured[0].fields.type,
							slug: featured[0].fields.slug,
						},
					}"
				>
					<div class="feature-img">
						<div
							:style="{
								backgroundImage:
									'url(' + featured[0].fields.hero.fields.file.url + ')',
							}"
				...
				<div class="border">
					<div class="type">
						{{ featured[0].fields.type.toUpperCase() }}
						<template v-if="featured[0].fields.type.toUpperCase() === 'BLOG'">
							<span v-if="featured[0].fields.author" class="tags">
								{{ featured[0].fields.author.fields.name.toUpperCase() }}
							</span>
						</template>
						<template v-else>
							<span v-if="featured[0].fields.client" class="tags">
								{{ featured[0].fields.client }}
							</span>
						</template>
					</div>
					<div class="desc">
...
@media screen and (max-width: 767px) {
	...
	/* The is a very import css selector ":not()" it helps you pass the oppiste of and argument */
	.c2alinks a:not(:hover) {
		background-image: linear-gradient(180deg, transparent 65%, #41c0bf 0);
		background-size: 0 100%;
	}
	.featured {
	...
	.feature-img {
		...
		height: 250px;
		overflow: hidden;
		border-bottom: solid 10px #41c0bf;
	}
	.feature-img-bck {
		width: 100%;
		height: 100%;
